...
class RecorderMeter(object):
  ...
  def plot_curve(self, save_path):
    save_extension=save_path[save_path.rindex('.'):]
    save_path=save_path[:save_path.rindex('.')]
    save_path_acc=save_path+"accuracy"+save_extension
    save_path_loss=save_path+"loss"+save_extension
    ...
    if save_path is not None:
      fig.savefig(save_path_acc, dpi=dpi, bbox_inches='tight')
    ...
    if save_path is not None:
      fig.savefig(save_path_loss, dpi=dpi, bbox_inches='tight')
      print ('---- save figure {} into {}'.format(title, save_path))
    plt.close(fig)
